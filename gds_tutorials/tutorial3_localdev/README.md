...
## Table of contents
* [1. Setup dscc gen](#Setup-dscc-gen)
    * [1.1 Install npm & node.js](#Install-npm-&-node.js)
    * [1.2 Set up a Google Storage Bucket](#Set-up-a-Google-Storage-Bucket)
* [2. Start a new dscc gen Community Visualization project](#Start-a-new-dscc-gen-Community-Visualization-project)
* [3. Preview your visualization locally](#Preview-your-visualization-locally)
* [4. dscc gen workflow](#dscc-gen-workflow)
* [5. Install d3](#Install-d3)
* [6. Understand dimensions and metrics](#Understand-dimensions-and-metrics)
* [7. Update your locally stored data with ``localMessage.js``](#Update-your-locally-stored-data-with-localMessage.js)
    * [7.1 Reformat index.json](#Reformat-index.json)
    * [7.2 Deploy local message](#Deploy-local-message)
    * [7.3 Get data in a new ``localMessage.js``](#Get-data-in-a-new-localMessage.js)
* [8. Write JavaScript for a bubble chart](#Write-JavaScript-for-a-bubble-chart)
* [9. Dev deployment](#Dev-deployment)
    * [9.1 Update manifest (optional)](#Update-manifest-(optional))
    * [9.2 Deploy your Viz!](#Deploy-your-Viz!)
* [10. Adding labels for each circle](#Adding-labels-for-each-circle)
* [11. Prod deployments](#Prod-deployments)
